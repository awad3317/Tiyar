<section class="mt-5" id="home" class="w-full top-0 left-0 pb-5 pb-md-4 mt-5" style="background-color: #F7FAFC;">
            ...
            <div class="col-md-7 order-md-1 order-1 mt-md-2 mt-5" data-aos="fade-left">
                <div class="hero-text mb-4 mb-md-0">
                    <h1 class="display-4 fw-medium text-dark mb-3">
                        نقود
                        <span class="fw-bold changing-text" style="color: #0A2463;">تيار</span>
                    </h1>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            setInterval(() => {
                ...
                }, 500); // وقت مطابق للـ transition في CSS
            }, 2500); // يتغير كل 2.5 ثانية
        });
    </script>
